...
import 'ideapitch_model.dart';
export 'ideapitch_model.dart';

class IdeapitchWidget extends StatefulWidget {
  const IdeapitchWidget({super.key});

  @override
  State<IdeapitchWidget> createState() => _IdeapitchWidgetState();
}

class _IdeapitchWidgetState extends State<IdeapitchWidget> {
  late IdeapitchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IdeapitchModel());
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            await IdeaRecord.collection
                                                .doc()
                                                .set(createIdeaRecordData(
                                                  name: _model
                                                      .emailNameController1
                                                      .text,
                                                  description: _model
